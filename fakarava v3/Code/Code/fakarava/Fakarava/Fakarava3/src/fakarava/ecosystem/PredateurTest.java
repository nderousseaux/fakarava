...
public class PredateurTest {
    ...
    static int gentille = baie.newProie("sandre", 30, 0, 1, 0);
    static int lola = baie.newPredateur("Morue agressive", 5, 0, 1);
    static int jackie = baie.newPredateur("Gros Poisson Rouge", 25, 0, 1);
    static int p1 = baie.newPasse(baie.getCellule(0, 1));
    ...
    public void testToString() {
        assertEquals("Prédateur --->  Nom:Morue agressive - Age:0 - Cellule:(1,2) - Poid:5,00",baie.getPoisson(lola).toString());
    }
