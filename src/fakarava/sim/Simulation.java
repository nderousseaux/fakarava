...
public class Simulation {
    public static void sim(String args[]){
        ...
        int gilber = Fakarava.createPrey("morue", 2.0, 0, 0, 70);
        int bertha = Fakarava.createPredator("Requin Marteau", 99.0, 0, 0);
        int adolphe = Fakarava.createPredator("Requin Gris", 75.0, 0, 0);
        int bertho = Fakarava.createPredator("Requin vorace", 50.0, 0, 0);
